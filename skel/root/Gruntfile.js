module.exports = function (grunt) {
    ...
    var directoryPackage = './{%= namePackage %}';
    ...
    grunt.initConfig({
        ...
        htmlmin: {
            all: {
                ...
                files: {
                    '{%= namePackage %}/public/edit.html': directoryPrivate + '/edit.html',
                    '{%= namePackage %}/public/view.html': directoryPrivate + '/view.html',
                },
            },
        },
        jshint: {
        ...
        less: {
            view: {
                options: {
                    sourceMap: true,
                    sourceMapFilename: '{%= namePackage %}/public/view.less.min.css.map',
                    outputSourceFiles: true,
                    cleancss: true,
                    compress: true,
                },
                files: {
                    '{%= namePackage %}/public/view.less.min.css':
            ...
            edit: {
                options: {
                    sourceMap: true,
                    sourceMapFilename: '{%= namePackage %}/public/edit.less.min.css.map',
                    outputSourceFiles: true,
                    cleancss: true,
                    compress: true,
                },
                files: {
                    '{%= namePackage %}/public/edit.less.min.css':
